...
import { ArrowDown, ArrowUp, DollarSign, Download, Receipt, TrendingUp, Wallet, WalletCards } from 'lucide-react';
            ...
            <div className="flex flex-col justify-between h-full">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <p className="text-2xl font-bold text-green-600">{chiffreAffaires.toLocaleString()} FCFA</p>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-blue-600">{(chiffreAffaires * 0.7).toLocaleString()} FCFA</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-purple-600">{(chiffreAffaires * 0.3).toLocaleString()} FCFA</div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {stat.trend && (
                      <div className={`flex items-center justify-center w-6 h-6 rounded-full ${stat.trend === 'up' ? 'bg-green-100' : 'bg-red-100'}`}>
                        {stat.trend === 'up' ? <ArrowUp className="w-4 h-4 text-green-600" /> : <ArrowDown className="w-4 h-4 text-red-600" />}
                      </div>
                    )}
                  </div>
                  {stat.title === 'Solde de Compte' && <p className={`text-xs font-medium ${isSoldePositif ? 'text-green-600' : 'text-red-600'}`}>{isSoldePositif ? 'Excédent' : 'Déficit'}</p>}
                </div>
