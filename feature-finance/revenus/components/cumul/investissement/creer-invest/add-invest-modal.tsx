  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="default" className="w-[240px] cursor-pointer  gap-1 md:gap-2 bg-amber-500 text-white hover:bg-amber-600 hover:text-white">
          <Plus />
          Ajouter <span className="hidden md:flex"> Investissement</span>
        </Button>
      </DialogTrigger>
          ...
          <div className="grid gap-6">
            ...
            <div className="grid gap-3">
              <div className="grid gap-3">
                ...
                <Input id="nomInvestisseur" placeholder="Nom de l'investisseur" type="text" {...register('nomInvestisseur')} />
                {errors.nomInvestisseur && <p className="text-red-500 text-sm">{errors.nomInvestisseur.message}</p>}
              </div>{' '}
            </div>
