...
export function PretList() {
  const { facture, isLoading, isError, error, filters, handleFilterChange, resetFilters } = usePretList();
    ...
    <div className="w-full px-4 py-6">
      <Card className="shadow-lg border-0">
        ...
        <CardContent className="p-0">
          <PretTable facture={currentPrets} formatDate={formatDate} formatMontant={formatMontant} currentPage={currentPage} totalPages={totalPages} totalItems={filteredPrets.length} />
