...
function LivreurStats({ totalTickets, totalLivraison, commissionTotale, isLoading, isError }: LivreurStatsProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
      {!isLoading && !isError && (
        <>
          ...
          <LivreurStatItem label="commission" value={formatCFA(commissionTotale)} valueColor="text-blue-500" labelColor="text-blue-500" />
        </>
      )}
