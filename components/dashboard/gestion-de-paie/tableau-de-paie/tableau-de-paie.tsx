                        ...
                        <TableRow key={index} className={"hover:bg-primary/10 cursor-pointer"} onClick={() => ctrl.openDetailModal(item)} >
                            <TableCell className="border-b-2">
                                <div className="flex items-center gap-4">
                                    <span className="w-7 h-7 rounded-full bg-surface-tertiary"> </span>
                                    <div className="flex flex-col gap-1">{item.nomComplet} {ctrl.getStatusChip(item.type)}</div>
                                </div>
                            </TableCell>
                            <TableCell className="border-b-2 text-muted">{item.total}&nbsp;&nbsp; FCFA</TableCell>
                            <TableCell className="border-b-2 text-muted">{item.gain}&nbsp;&nbsp; FCFA</TableCell>
                            <TableCell className="border-b-2 text-muted">
                            ...
                            <TableCell className="border-b-2 text-muted">{item.taux}</TableCell>
                            <TableCell className="border-b-2 text-muted">{item.commission}&nbsp;&nbsp; FCFA</TableCell>
                            <TableCell className=" border-b-2 text-muted">
                ...
                {(!ctrl.data || ctrl.data.length === 0) ? (
                    ...
                    ctrl.data.map((item: PaieParLivreur, index) => (
                        <div
                            ...
                            className="cursor-pointer space-y-2 rounded-xl border border-separator bg-surface p-4 shadow-xs active:bg-primary/5"
                        >
