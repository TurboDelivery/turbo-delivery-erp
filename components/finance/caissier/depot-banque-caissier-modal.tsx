...
import type { IDepotBanqueCaissierBody } from '@/features/caissier';
...
// SPEC-RECOUV-002 — référentiel simple des comptes Turbo (à remplacer par un
// vrai référentiel quand il existera). Choix libre possible via "Autre".
