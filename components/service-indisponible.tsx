    ...
    <div className="flex h-screen w-full items-center justify-center bg-background">
      <div className="max-w-md space-y-6 px-4 text-center">
        ...
        <div className="flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/auth"
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-muted-surface"
          >
            Se reconnecter
          </Link>
        </div>
