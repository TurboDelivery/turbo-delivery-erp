    ...
    <div className="flex-1 bg-white rounded-2xl border border-gray-200 p-5 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-semibold text-gray-800">Verrouillés V2</h2>
        </div>
      ...
      {tickets.length === 0 ? (
        <div className="flex flex-1 items-center justify-center py-16">
          <p className="text-sm text-gray-400">Aucun ticket verrouillé pour cette semaine.</p>
        </div>
      ) : (
          ...
          {tickets.map((ticket) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="text-sm font-bold text-gray-900 whitespace-nowrap">{ticket.amount}</span>
