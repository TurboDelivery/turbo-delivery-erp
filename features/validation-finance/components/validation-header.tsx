      ...
      <div className="px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted">Gestion des flux financiers</p>
          </div>
          <div className="flex items-center gap-4">
            <button className="relative rounded-full p-2 hover:bg-surface-secondary transition-colors">
              {pendingCount > 0 && (
