  ...
  return (
    <div className="w-full h-full pb-10 flex flex-1 flex-col gap-4 min-w-[200px] overflow-auto ">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-primary">Gestions des tickets : Commandes terminées</h1>
      </div>
      ...
      <Table aria-label="Example table with custom cells" className="min-w-[700px] w-full ">
        ...
        <TableBody
          ...
          emptyContent={isLoading ? ' ' : 'Aucun ticket sur cette période'}
        >
      ...
      <BonLivraisonMobileList>
        {isLoading ? (
          ...
          <p className="text-sm text-gray-400 text-center py-10">Aucun ticket sur cette période</p>
        ) : (
          (data ?? []).map((item) => (
