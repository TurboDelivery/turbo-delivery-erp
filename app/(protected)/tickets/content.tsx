              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                <div>
                  ...
                  <Select
                    ...
                    value={livreurOptions.find((o) => o.value === filterLivreur) ?? null}
                    onChange={(opt) => setFilterLivreur(opt?.value ?? '')}
                ...
                <div>
                  ...
                  <Select
                    ...
                    value={restaurantOptions.find((o) => o.value === filterRestaurant) ?? null}
                    onChange={(opt) => setFilterRestaurant(opt?.value ?? '')}
        ...
        {activeTab === 'livreur' && (
          <div className="p-4 sm:p-6">
            <div className="mb-6">
              ...
              <Select
                options={livreurOptions}
                value={livreurOptions.find((o) => o.value === selectedLivreur) ?? null}
                onChange={(opt) => setSelectedLivreur(opt?.value ?? '')}
                placeholder="Tous les livreurs"
                isClearable
                className="text-xs"
                classNamePrefix="react-select"
