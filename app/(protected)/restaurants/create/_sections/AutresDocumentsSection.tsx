...
export function AutresDocumentsSection({
  ...
  return (
    <section>
      ...
      <p className="text-xs text-gray-400 mb-3">Sélectionnez un document fourni par l'entreprise</p>
      <div className="flex items-center gap-3">
        <Select
          ...
          onSelectionChange={(keys) => onTypeChange(Array.from(keys as Set<string>)[0] ?? 'contrat')}
        >
